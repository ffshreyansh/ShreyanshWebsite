    ...
    var countDownClock = 
    {
		...
		{  
		    ...
		    var currentDate = new Date();
		        ...
		        daysCount = ('10' + Math.abs(Math.floor((dateDif)/(1000*60*60*24)))).slice(-4),
		        hoursCount = ('10' + Math.abs(Math.floor(date[3] - currentDate.getHours()))).slice(-2),
		        minuteCount = ('10' + Math.abs(Math.floor(date[4]-currentDate.getMinutes()))).slice(-2),
		        secondCount = ('10' + Math.abs(Math.floor(date[5]-currentDate.getSeconds()))).slice(-2),
